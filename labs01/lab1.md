...
19. Update the version of the image used by the deployment to **v2**. You can modify dep.yaml and apply the changes as we have done before 'kubectl apply -f dep.yaml'. If you’re feeling vim-venturous you could try `kubectl edit deploy hello`. Make tyhe change and save,  automatically apply the changes. It’s entirely up to you but however you do it, once you’ve done it, list your pods, rs and deployments again. 
